...
<body>
    ...
    <a class="logo" href="index.php"> <img src="images/logo.jpg" alt="image">  </a>  
        ...
        <nav class="header-right">
            ...
            <a class="active" href="login.php"><strong> Login </a></b>             
            </nav>
    </div>
           ...
           <p style="text-align:center; font-weight:bold"><em>Don't have an account?<br> Click <a href="reg.php"> SignUp </a> </em> </p>
            <form action="login.php" method="POST">
                ...
                <div class="logdetail">
                  ...
                  <strong>Username </b> <input type="text" name="username" placeholder="Enter username" required >
                    <strong>Password </b> <input type="password" name="password" placeholder="Enter password" required>
