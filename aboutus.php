 ...
 <div class="header">
    <a class="logo" href="index.php"> <img src="images/logo.jpg" alt="image">  </a>
            ...
            <nav class="header-left">
               ...
               <a class="active" href="aboutus.php"><strong> About </a></b>
            ...
            <div class="title">
                ...
                <div clas="content">
                    <div class="article">
                        ...
                        <a href="https://www.facebook.com/alizzzz.7" target="_blank"><i class="fa fa-facebook-official" style="color:blue; font-size:40px"></i></a> 
                        <a href="https://www.instagram.com/ali_husssain_/" target="_blank"> <i class="fa fa-instagram" style="color:magenta; font-size:40px"></i> </a> 
                        <a href="https://mobile.twitter.com/hussy_23" target="_blank"><i class="fa fa-twitter-square" style="color:#00acee; font-size:40px" ></i> </a>
                        </p>
